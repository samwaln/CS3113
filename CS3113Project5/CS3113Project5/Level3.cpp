...
unsigned int level3_data[] =
{
    ...
    6, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 6,
    6, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 50, 12, 12, 12, 12, 12, 6,
    6, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 50, 12, 50, 50, 50, 50, 12, 50, 50, 6,
    6, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 50, 50, 12, 50, 12, 12, 12, 12, 12, 12, 6,
    6, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 50, 50, 50, 12, 50, 12, 12, 12, 62, 12, 12, 6,
    6, 0 , 1 , 1 , 1 , 2 , 12, 34, 12, 34, 12, 0 , 1 , 1 , 1 , 2 , 12, 0 , 1 , 1 , 1 , 2 , 12, 12, 6,
    6, 7 , 8 , 8 , 8 , 9 , 12, 12, 12, 12, 12, 7 , 8 , 8 , 8 , 9 , 12, 7 , 8 , 8 , 8 , 9 , 12, 12, 6
};
...
void Level3::Initialize(int lives) {
    ...
    state.enemies[1].position = glm::vec3(21.0f, 0.00f, 0.0f);
...
void Level3::Render(ShaderProgram *program) {
    ...
    if ((state.player.position.x >= 21 && state.player.position.y <= -4) || state.nextLevel == -2) {
        glm::vec3 loc1 = glm::vec3(0, 0, 0);
        glm::vec3 loc2 = glm::vec3(0, 0, 0);
        if (state.player.position.x > 5) {
